...
export default function HeroSection() {
    ...
    return (
        <section
            ref={targetRef}
            className="mt-[5rem] max-w-[90rem] h-screen mx-auto flex justify-center items-center relative overflow-hidden"
        >
            ...
            >
                <motion.h1
                    className="hero-name text-7xl md:text-9xl font-bold mb-4 leading-none tracking-tighter bg-clip-text text-transparent dark:text-transparent animate-bg-shine bg-[length:250%_100%] duration-[2200ms]
          ...
          bg-[linear-gradient(110deg,#09090B,45%,#fff,55%,#09090B)]"
                ...
                <motion.h2
                    className="hero-title text-3xl md:text-4xl font-bold mb-6 leading-tight text-black"
                ...
                <motion.p
                    className="hero-subtitle text-xl md:text-2xl max-w-2xl mb-8 text-gray-700"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
