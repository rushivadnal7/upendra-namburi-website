...
export default function AboutSection() {
    ...
    return (
        <section ref={aboutRef} className="py-32 min-h-screen flex items-center relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                <motion.h2
                    className="section-heading text-5xl md:text-6xl font-bold mb-20 inline-block"
                ...
                <div className="flex justify-center max-w-7xl mx-auto items-center gap-16 mt-16">
                    ...
                    <motion.div
                        ref={imageRef}
                        className="about-image-container w-[50%] relative h-[600px] perspective-1000"
                        style={{ y: imageY }}
                    >
